...
export default function TreatmentRecommendations({ recommendations }: TreatmentRecommendationsProps) {
  if (!recommendations) {
    return (
      <section aria-labelledby="treatment-recommendations-title">
        <Card className="w-full mt-6">
          <CardHeader>
            <CardTitle id="treatment-recommendations-title">Treatment Recommendations</CardTitle>
            <CardDescription>AI-powered suggestions for your aquarium.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col items-center justify-center h-32 text-muted-foreground" role="status" aria-live="polite">
  ...
  return (
    <section aria-labelledby="treatment-recommendations-title">
      <Card className="w-full mt-6 shadow-lg">
        <CardHeader>
          <CardTitle id="treatment-recommendations-title" className="text-2xl">Treatment Recommendations</CardTitle>
