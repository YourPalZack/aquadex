  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <CardDescription>Select an image of your aquarium test strip for AI analysis.</CardDescription>
      </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          {preview && (
            <div className="mt-4 border rounded-md p-2 aspect-video relative overflow-hidden">
              <Image src={preview} alt="Test strip preview" layout="fill" objectFit="contain" />
            </div>
          )}
