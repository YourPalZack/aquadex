...
const footerLinks = {
  product: [
    { name: 'Features', href: '/for-fishkeepers' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg">AquaDex</span>
            </div>
            <p className="text-sm text-muted-foreground">
              The fishkeeper's toolkit for smart aquarium management, AI-powered insights, and community connection.
            </p>
          </div>
